...
using Pe.ByS.ERP.Infraestructura.Model.Command.IMP;

namespace Pe.ByS.ERP.Infraestructura.Model.IMP.Mapping
{
    /// <summary>
    /// Implementación del mapeo de la entidad Bien
    /// </summary>
    /// <remarks>
    /// Creación:   20150527 <br />
    /// Modificación:            <br />
    /// </remarks>
    public class SolicitudGestionPermisoMapping : BaseEntityMapping<SolicitudGestionPermisoEntity>
    {
        public SolicitudGestionPermisoMapping()
            : base()
        {

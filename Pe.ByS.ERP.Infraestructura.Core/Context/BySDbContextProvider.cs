...
namespace Pe.ByS.ERP.Infraestructura.Core.Context
{
    ...
    /// Modificación:            <br />
    /// </remarks>
    public class BySDbContextProvider : DbContext, IDbContextProvider
    {
        /// <summary>
        ...
        {
            string assemblyName = ConfigurationManager.AppSettings["BySModelAssembly"];
        ...
        public IDbSet<T> DbSet<T>() where T : Model.Base.Entity
        {
            return this.Set<T>();
        }
        /// <summary>
        ...
        public T Modified<T>(T entity) where T : Model.Base.Entity
        {
